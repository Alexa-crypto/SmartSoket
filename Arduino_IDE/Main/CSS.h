void append_page_header() {
  ...
  webpage += F(".progress-bar {width: 100%;height: 30px;background-color: #f2f2f2;border-radius: 5px;}");
  webpage += F(".progress {height: 100%;background-color: #4caf50;border-radius: 5px;}");
